...
-- TEMPLATE II-A)
-- SELECT (Vars as in the GROUP BY CLAUSE) ,COUNT(*)
-- FROM sample_r_b
-- JOIN sample_r_l
--     ON sample_r_b.PNUM_R = sample_r_l.PNUM_R
...
-- TEMPLATE II-B)
-- SELECT (Vars as in the GROUP BY CLAUSE) ,COUNT(*), glue_expression(random_select(bag of [AGG_FNTN]) + random_select(bag of [PRNT_CNT_VAR / bag of  PRNT_DT_VAR/bag of CHLD_CNT_VAR / bag of  CHLD_DT_VAR]))
-- FROM sample_r_b
-- JOIN sample_r_l
--     ON sample_r_b.PNUM_R = sample_r_l.PNUM_R
