...
def fuzz_tabular(n_queries: int, real_file_path, metadata_file_path, syn_file_path='None', query_type= 'single_agg') -> dict:
...
fuzz_tabular(100, '/home/samer/projects/fuzzy_sql/data/real/oncovid_dtd.csv', '/home/samer/projects/fuzzy_sql/data/metadata/oncovid_dtd.json', query_type='single_agg')
fuzz_tabular(100, '/home/samer/projects/fuzzy_sql/data/real/oncovid_dtd.csv', '/home/samer/projects/fuzzy_sql/data/metadata/oncovid_dtd.json', query_type='single_fltr')